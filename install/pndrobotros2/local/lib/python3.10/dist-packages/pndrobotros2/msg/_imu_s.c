...
bool pndrobotros2__msg__imu__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("pndrobotros2.msg._imu.Imu", full_classname_dest, 25) == 0);
  }
  pndrobotros2__msg__Imu * ros_message = _ros_message;
  {  // yaw
...
PyObject * pndrobotros2__msg__imu__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("pndrobotros2.msg._imu");
